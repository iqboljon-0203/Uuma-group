...
export default function Hero() {
  ...
  useEffect(() => {
    getSiteContent(['hero_title', 'hero_subtitle', 'hero_desc', 'hero_tagline', 'hero_cta']).then(data => {
      setContent(data);
    });
  }, []);
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-6 pt-24 md:pt-40 pb-16 w-full">
        ...
        >
          ...
          <h1 className="flex flex-col gap-4 mb-8">
            ...
            >
              {d('hero_subtitle', t.hero.subtitle)}
            </motion.span>
          </h1>
